package com.acedatacloud.mcp.luma
...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Luma MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/MCPLuma")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-luma/")
                }
            }
        }
